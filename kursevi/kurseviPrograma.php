...
<body>
  <img src="/store/slike/logo.jpg" alt="Kamp kod" id="baner"><br><br>
    <h1 class="text-center">Kursevi programa</h1>
<!--Snizeni kursevi-->
     <div class="container"> 
    <?php
    require_once("connection.php");
    $upit = "SELECT * from kursevi where idKursa = 3 || idKursa = 4 order by idKursa asc LIMIT 2";
  ...
  <h1 class="h1">Kursevi u pripremi</h1>
      <div class="row">
        <div class="column">
           <img src="/store/slike/photoshop.jpg" alt="Osnove programa Photoshop" width="410" height="463" id="slika1">
        </div>
        <div class="column">
          <div class="column">
            <img src="/store/slike/3dMax.jpg" alt="Osnove programa 3D Max" width="410" height="463" id="slika2">
          </div>       
        </div>
      </div>
  </body>
