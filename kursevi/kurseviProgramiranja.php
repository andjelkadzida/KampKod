...
<body>
  <img src="/store/slike/logo.jpg" alt="Kamp kod" id="baner">
    <h1 class="text-center">Kursevi programiranja</h1>
<!--Snizeni kursevi-->
     <div class="container"> 
    <?php
    require_once("connection.php");
    $upit = "SELECT * from kursevi order by idKursa asc LIMIT 2";
  ...
  <h1 class="h1">Kursevi u pripremi</h1>
       <div class="row">
        <div class="column">
           <img src="/store/slike/java.jpg" alt="Osnove programskog jezika Java" width="410" height="463" id="slika1">
        </div>
        <div class="column">
          <div class="column">
            <img src="/store/slike/cSharp.jpg" alt="Osnove programskog jezika C#" width="410" height="463" id="slika2">
          </div>       
        </div>
      </div>
  </body>
